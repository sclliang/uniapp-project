<template>
	<view class="container-home">
		...
		<!-- 轮播图 -->
		<uni-swiper-dot :info="swiperList" :current="current" field="content" :mode="mode" :dotsStyles="dotsStyles">
			<swiper class="swiper-box" @change="change" autoplay :interval="3000" :duration="1000" circular>
		...
		<view class="floor-list">
			<block v-for="(item, index) in floorList" :key="index">
				...
				<view class="floor-img-box">
					...
					<view class="right">
						<block v-for="(product, product_index) in item.product_list.slice(1)" :key="product_index">
